...
import { VNS_click_callback, VNS_scroll_callback, EL_callback , EL_callback_1} from './hp_middle.js';
...
let VNS_panel_1 = new Homepage_Panel(
    homepage_vns_url_1,
    vns_panel_title,
    vns_btn_name_template,
    vns_panel_name,
    VNS_click_callback,
    VNS_scroll_callback
);
...
const EL_panel_1 = new Homepage_Panel(homepage_el_url, el_panel_title,
    el_btn_name_template, el_panel_name, EL_callback_1);



export {
    VNS_panel as VNS_panel,
    VNS_panel_1 as VNS_panel_1,
    // Chart_panel as Chart_panel,
    EL_panel as EL_panel,
    EL_panel_1 as EL_panel_1
};