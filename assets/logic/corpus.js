...
class Corpus_Card {
    ...
    _createCard() {
        ...
        let cardText_Html = `<div class="card-text"><strong>Venue</strong>: ${this._description}</div><div class="card-text"><br><strong>Source</strong>: ${this._source}, <strong>Year</strong>: ${this._year}, <a href="${this._link}" target="_blank" style="color: #007DFF">Link</a><div>${this._method}</div></div>`;
