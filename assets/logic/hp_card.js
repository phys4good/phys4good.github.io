...
let front_preview_html = `<img class="card-img front-preview front-preview-contain" src="./assets/${this.parameters["snapshot"]}">`
    ...
    */
    ...
    _createCard_footer(direction = 1) {
        // If this is a _1 card (snapshot path includes card_img_1/), skip footer
        if (this.parameters["snapshot"] && this.parameters["snapshot"].includes("card_img_1/")) {
            let empty_footer_node = document.createElement("div");
            empty_footer_node.classList.add("card-footer");
            return empty_footer_node;
        }
        ...
        if (direction > 0) {
            ...
            //底部文字：来源
            if (!this.parameters["snapshot"].includes("card_img_1/")) {
